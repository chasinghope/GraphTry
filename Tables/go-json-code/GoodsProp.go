...
const TypeId_GoodsProp = -896519239

func (*GoodsProp) GetTypeId() int32 {
    return -896519239
}

func NewGoodsProp(_buf map[string]interface{}) (_v *GoodsProp, err error) {
    _v = &GoodsProp{}
    { var _ok_ bool; var _tempNum_ float64; if _tempNum_, _ok_ = _buf["id"].(float64); !_ok_ { err = errors.New("id error"); return }; _v.Id = int32(_tempNum_) }
    { var _ok_ bool; var _tempNum_ float64; if _tempNum_, _ok_ = _buf["minScore"].(float64); !_ok_ { err = errors.New("minScore error"); return }; _v.MinScore = int32(_tempNum_) }
    { var _ok_ bool; var _tempNum_ float64; if _tempNum_, _ok_ = _buf["maxScore"].(float64); !_ok_ { err = errors.New("maxScore error"); return }; _v.MaxScore = int32(_tempNum_) }
